...
import termsMarkdown from "../../Mizan AI Terms of Service.md?raw";

export default function Terms() {
  const updatedMatch = termsMarkdown.match(/Last Updated:\s*\[?\*\*(.+?)\*\*\]?/i);
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="mt-16 md:mt-20 mb-16 md:mb-20 pt-12 md:pt-16 pb-10 bg-gradient-to-br from-neutral-50 to-primary-50/30">
        <div className="container-custom text-center">
          ...
          <h1 className="text-neutral-900 mb-3">Terms of Service</h1>
          {lastUpdated && (
